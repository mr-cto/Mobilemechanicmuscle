      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="bg-gray-900/50 p-8 rounded-xl border border-white/10">
          ...
          <p className="text-gray-300 mb-6">
            Our bill pay feature is now available directly from the header menu.
            Click the "Billing" button in the navigation bar to access it.
          </p>

          <div className="flex justify-center">
            <BillingButton initialTab="pay" />
          </div>
